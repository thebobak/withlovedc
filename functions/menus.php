...
register_nav_menus(array(
    'top-bar-l'     => 'Top Menu:  Left', // registers the menu in the WordPress admin menu editor
    'top-bar-r'     => 'Top Menu:  Right',
    'hp-menu'       =>  'Home Page Menu',
